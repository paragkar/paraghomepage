...
with st.container():
	...
	st.write("I wrote this app to tell the story about the telecom industry through Data Visulization")
	st.code("st.markdown('The app is structured in four dimensions - 1) :Spectrum Bands[blue]; 2) Auction Years; 3) Business Data; 4) Auction Data')")
